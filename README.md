...
Against five state-of-the-art directed fuzzers (AFLGo, BEACON, WindRanger,
SelectFuzz, AFLGo-Fuzz), AFLGopher reaches target sites 2.5–3.8× faster and triggers
